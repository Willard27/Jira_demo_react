...
import { getProjectListAsync, select_project_list, select_project_modal, select_project_orgs, select_project_users, set_project_modal } from '../../redux/slice/project';

function CreateProjectModal() {
    const dispatch = useDispatch()

    const orgs = useSelector(select_project_orgs)
